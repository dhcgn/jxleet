...
green, then blue for the strongest form — and rows that are a plain limitation (like
*8×8 blocks only* at the low efforts) stay yellow. Every level cell has a tooltip saying
...
The ladder follows that document.
